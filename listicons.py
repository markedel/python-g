...
class ListTypeIcon(icon.Icon):
    ...
    def __init__(self, leftText, rightText, window, leftImgFn=None,
            rightImgFn=None, closed=True, typeoverIdx=None, obj=None, location=None):
    ...
    def typeoverCursorPos(self):
        #... I think this function can be removed as single character typeover icons
        #    can't hold cursor
        print('typeoverCursorPos for list type icon called')
        xOffset = self.sites.attrIcon.xOffset + icon.ATTR_SITE_DEPTH - icon.TEXT_MARGIN
        return xOffset, self.sites.attrIcon.yOffset

    def typeoverActiveSite(self):
        return iconsites.makeSeriesSiteId('argIcons', len(self.sites.argIcons) - 1)
...
class ListIcon(ListTypeIcon):
    def __init__(self, window, closed=True, obj=None, typeoverIdx=None, location=None):
        if obj is not None:
        ...
        ListTypeIcon.__init__(self, '[', ']', window, obj=obj, location=location,
                ...
                rightImgFn=self._stretchedRBracketImage, typeoverIdx=typeoverIdx)
    ...
    def _stretchedRBracketImage(self, desiredHeight):
        img = listRBktImage if self.typeoverIdx is None else listRBktTypeoverImage
        return icon.yStretchImage(img, listRBrktExtendDupRows, desiredHeight)

class TupleIcon(ListTypeIcon):
    def __init__(self, window, noParens=False, closed=True, obj=None, typeoverIdx=None,
                 location=None):
        ...
        ListTypeIcon.__init__(self, '(', ')', window, closed=closed, obj=obj,
                ...
                rightImgFn=self._stretchedRTupleImage, typeoverIdx=typeoverIdx)
        if noParens:
    ...
    def _stretchedRTupleImage(self, desiredHeight):
        ...
        elif self.typeoverIdx is not None:
...
class DictIcon(ListTypeIcon):
    def __init__(self, window, closed=True, obj=None, typeoverIdx=None, location=None):
        ...
        ListTypeIcon.__init__(self, '{', '}', window, obj=obj,
                ...
                typeoverIdx=typeoverIdx, location=location)
    ...
    def _stretchedRBraceImage(self, desiredHeight):
        img = rBraceImage if self.typeoverIdx is None else rBraceTypeoverImage
...
class CallIcon(icon.Icon):
    ...
    def __init__(self, window, closed=True, typeoverIdx=None, location=None):
        icon.Icon.__init__(self, window)
        self.closed = False
        self.typeoverIdx = typeoverIdx
        if typeoverIdx is not None:
    ...
    def draw(self, toDragImage=None, location=None, clip=None, style=None):
        if self.drawList is None:
            ...
            if self.closed:
                ...
                rParenSrcImg = fnRParenImage if self.typeoverIdx is None else \
                        fnRParenTypeoverImage
    ...
    def typeoverCursorPos(self):
        #... I think this function can be removed as single character typeover icons
        #    can't hold cursor
        print('typeoverCursorPos for call icon called')
        xOffset = self.sites.attrIcon.xOffset + icon.ATTR_SITE_DEPTH - icon.TEXT_MARGIN
        return xOffset, self.sites.attrIcon.yOffset
